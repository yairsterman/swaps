...
var messages = {
    ...
    registration: function(user){
        return '<div style="width:65%;margin:auto;padding:3%;border: 1px solid rgba(199, 167, 104, 0.4);"> <div style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">Welcome To Swaps </div></br>' +
