...
const SIGNITURE = '<div class="swaps-signature" style="margin:4vw;padding:4vw;line-height: 1.4"><div><a class="no-decoration pointer" style="cursor:pointer;text-decoration: none;" href="https://swapshome.com">Swapshome.com</a></div>' +
    '<div>Tel Aviv, Israel</div></div>';
const TOP = `<div class="swaps-logo" style="width:100px; height: 100px; margin:15px auto;"><img style="width:100px; height: 100px;" src="${LOGO}"></div>`;
...
var messages = {
    ...
    registration: function(user){
        return '<div style="background-color: #f3f4f5">' + TOP +  '<div class="swap-wrapper" style="margin:6vw;padding:6vw;border-bottom: 1px solid rgba(199, 167, 104, 0.4);"> <div class="swap-title" style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">Welcome To Swaps </div></br>' +
    ...
    confirmation: function(user, swapper, dates){
        return '<div style="background-color: #f3f4f5">' + TOP + '<div class="swap-wrapper" style="margin:6vw;padding:6vw;border-bottom: 1px solid rgba(199, 167, 104, 0.4);"> <div class="swap-title" style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">Swap Confirmed!</div></br>' +
    ...
    request: function(user, swapper, dates, nights, message){
        return '<div style="background-color: #f3f4f5">' + TOP + '<div class="swap-wrapper" style="margin:6vw;padding:6vw;border-bottom: 1px solid rgba(199, 167, 104, 0.4);"> <div class="swap-title" style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">New Swap Request!</div></br>' +
    ...
    requestSent: function(user, swapper){
        return '<div style="background-color: #f3f4f5">' + TOP + '<div class="swap-wrapper" style="margin:6vw;padding:6vw;border-bottom: 1px solid rgba(199, 167, 104, 0.4);"> <div class="swap-title" style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">Swap Request Sent</div></br>' +
    ...
    canceled: function(user, swapper, message){
        return '<div style="background-color: #f3f4f5">' + TOP + '<div class="swap-wrapper" style="margin:6vw;padding:6vw;border-bottom: 1px solid rgba(199, 167, 104, 0.4);"> <div class="swap-title" style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">Swap Canceled</div></br>' +
    ...
    declined: function(user, swapper, message){
        return '<div style="background-color: #f3f4f5">' + TOP + '<div class="swap-wrapper" style="margin:6vw;padding:6vw;border-bottom: 1px solid rgba(199, 167, 104, 0.4);"> <div class="swap-title" style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">Swap Declined</div></br>' +
    ...
    message: function(user, swapper){
        return '<div style="background-color: #f3f4f5">' + TOP + '<div class="swap-wrapper" style="margin:6vw;padding:6vw;border-bottom: 1px solid rgba(199, 167, 104, 0.4);"> <div class="swap-title" style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">New Message</div></br>' +
    ...
    review: function(user, token){
        return '<div style="background-color: #f3f4f5">' + '<div class="swap-wrapper" style="margin:6vw;padding:6vw;border-bottom: 1px solid rgba(199, 167, 104, 0.4);"> <div class="swap-title" style="text-align:center;font-size:30px;font-weight:bold;color:#0E5D7C;margin-bottom:15px">How Was Your Swap? </div></br>' +
